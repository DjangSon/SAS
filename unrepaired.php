	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		if (!empty($_REQUEST['act'])){
			...
			$datas2 = $database -> select("staff", "*",[
					"realname" => base64_decode(base64_decode($_COOKIE['admin']))
			]);
			...
			if ($act == "usematerial"){
				$database -> update("property", [
						...
						"fixer" => base64_decode(base64_decode($_COOKIE['admin'])),
						"fixphone" => $phone,
						"flag" => 1
				],[
						"ID" => $_POST['id']
				]);
				alertAndLoading("已处理成功", "unrepaired.php");
			}
		}
	}
?>
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li><a href="index.html"><i class="icon fa fa-cog"></i>待修理</a></li>
							</ol>						
						</div>
						...
						<div class="col-lg-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6><i class="fa fa-table"></i><span class="break"></span>待修表</h6>
												...
												foreach ($datas as $data){
													echo '
														<tr>
															...
															<td>'.$data['reason'].'</td>
															<td>'.$data['protime'].'</td>
														<form method="post" action="unrepaired.php?act=usematerial">
															<td><input type="text" class="dis-inp text-center" name="material" ></td>
															<input type="hidden" name="id" value="'.$data['ID'].'">
															<td><button type="submit" class="mybtn mybtn1" >处理</button></td>
														</form>	
														</tr>';
												}
											?>
